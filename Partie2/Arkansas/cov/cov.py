...
soil_z1  = pd.read_csv('AR_df_zone1_with_soil.csv')
soil_z2  = pd.read_csv('AR_df_zone2_with_soil.csv')
topo_z1  = pd.read_csv('AR_df_zone1_with_topo.csv')
topo_z2  = pd.read_csv('AR_df_zone2_with_topo.csv')
clim_z1  = pd.read_csv('AR_df_zone1_with_clim.csv')
clim_z2  = pd.read_csv('AR_df_zone2_with_clim.csv')
...
ax.axis('off')
fig.suptitle(
    'Plage de valeurs des covariables par culture — Arkansas',
...
plt.tight_layout()
plt.savefig('AR_covariables_ranges.png', dpi=150, bbox_inches='tight')
print("✅ AR_covariables_ranges.png")
plt.show()